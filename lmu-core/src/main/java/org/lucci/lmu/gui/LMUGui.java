...
public class LMUGui extends JFrame {
	public static void main(String[] args) {
		new LMUGui("load /home/benjamin/Bureau/org.jar");
	}
	...
	JMenuItem fileSaveButton = new JMenuItem("Save the current file",
			new ImageIcon(getClass().getResource("Save.png")));
	JMenuItem fileSaveAsButton = new JMenuItem("Save the current file using a different name",
			new ImageIcon(getClass().getResource("SaveAs.png")));
	JMenuItem fileCloseButton = new JMenuItem("Close (potentially save) the current file",
			new ImageIcon(getClass().getResource("Delete.png")));
	JMenuItem fileExportButton = new JMenuItem("Export the current model file to various file formats",
			new ImageIcon(getClass().getResource("SaveDB.png")));
	...
	private void buildWidgets() {
		...
		this.assistantLabel.setText(
				"Hi! I'm the LMU code analyser. I'm gonna <b>help</b> you!<br>You can start describing your object-oriented model using the LMU language. Enjoy!");
