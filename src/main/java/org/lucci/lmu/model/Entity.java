...
public class Entity extends NamedModelElement
{
	...
	public void setName(String name)
	{
		...
		{
			throw new IllegalArgumentException("an entity with the same name already exist");
		}
	...
	{
		Assertions.ensure(e.getName().equals(getName()), "entities must have the same name");

		for (Attribute a : e.getAttributes())
		{
			Attribute correspondingLocalAttribute = Attributes.findAttributeByName(this, e.getName());
		...
		{
			Operation correspondingLocalOperation = Operations.findOperationByName(this, e.getName());
